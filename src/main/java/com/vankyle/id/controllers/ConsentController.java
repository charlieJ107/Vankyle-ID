...
import com.vankyle.id.models.ConsentResponse;
...
public class ConsentController {
    ...
    public @ResponseBody ConsentResponse consent(
            Principal principal,
        ...
        scopesToApprove.forEach(scopeId ->
                response.getScopesToApprove().add(new ConsentResponse.Scope(scopeId, scopeId, scopeId, false)));
        previouslyApprovedScopes.forEach(scopeId ->
                response.getPreviouslyApprovedScopes().add(new ConsentResponse.Scope(scopeId, scopeId, scopeId, true)));
        return response;
    }
}
